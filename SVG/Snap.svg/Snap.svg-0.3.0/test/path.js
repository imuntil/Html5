describe("Path methods", function () {
    ...
    it("Snap.path.toAbsolute", function() {
        ...
        checkNext(['V', 40]);
        checkNext(['H', 10]);
        checkNext(['Ss.L', 10, 10]);
        checkNext(['M', 10, 50]);
        checkNext(['Ss.L', 40, 50]);
        checkNext(['Ss.L', 40, 90]);
        checkNext(['Ss.L', 10, 90]);
        checkNext(['M', 10, 100]);
    ...
    it("Snap.path.toRelative", function() {
        var absPath = "M10 10 H 50 V 40 H 10 Ss.L 10 10" +
                    "M10 50 Ss.L 40 50 Ss.L 40 90 Ss.L 10 90" +
    ...
    it("Snap.path.isPointInside", function () {
        var path = "M10 10 H 50 V 40 H 10 Ss.L 10 10 Z" +
            "M10 50 Ss.L 40 50 Ss.L 40 90 Ss.L 10 90 Z" +
